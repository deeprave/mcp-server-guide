...
COMMANDS = {
    ...
    CMD_AGENT_INFO: CommandInfo(
        ...
        category="utility",
        usage_pattern=f":{CMD_AGENT_INFO}",
        accepts_user_content=False,
        has_prompt_document=False,
    ),
    ...
    CMD_COLLECTION: CommandInfo(
        ...
        category="management",
        usage_pattern=f":{CMD_COLLECTION}",
        accepts_user_content=False,
        has_prompt_document=False,
    ),
