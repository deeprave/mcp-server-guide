...
def test_project_config_manager_initialization():
    ...
    assert manager.CONFIG_FILENAME == ".mcpguide.config.json"
...
def test_config_file_watcher_complete():
    ...
    from mcpguide.project_config import ConfigFileWatcher
...
def test_config_change_handler_complete():
    ...
    from mcpguide.project_config import ConfigChangeHandler
