...
from mcpguide.tools.config_tools import set_project_config
    ...
    def test_project_changes_do_not_auto_save(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                from mcpguide.tools.project_tools import switch_project
    ...
    def test_graceful_handling_when_no_saved_session_exists(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                session = SessionManager()
                assert session.current_project == "mcpguide"  # Default project name
