...
from mcpguide.server import mcp
from mcpguide.tools.file_tools import list_files, file_exists, get_file_content
from mcpguide.tools.project_tools import get_current_project, switch_project, list_projects
...
def test_tools_are_importable():
    ...
    from mcpguide.tools import config_tools, content_tools, file_tools, project_tools, session_management
...
def test_tools_are_callable():
    ...
    from mcpguide.tools.config_tools import get_project_config
    from mcpguide.tools.content_tools import get_guide
    from mcpguide.tools.file_tools import list_files
    from mcpguide.tools.project_tools import get_current_project
    from mcpguide.tools.session_management import save_session
...
def test_tools_with_parameters():
    ...
    from mcpguide.tools.config_tools import get_project_config, set_project_config
    from mcpguide.tools.content_tools import get_guide, get_language_guide
...
def test_content_tools_comprehensive():
    ...
    from mcpguide.tools.content_tools import (
        get_guide,
        get_language_guide,
        get_project_context,
        get_all_guides,
...
def test_config_tools_comprehensive():
    ...
    from mcpguide.tools.config_tools import (
        get_project_config,
        set_project_config,
        get_effective_config,
        get_tools,
