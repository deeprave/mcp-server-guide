...
class TestIsSpeckitEnabled:
    ...
    def test_enabled_when_speckit_is_true(self):
    ...
    def test_disabled_when_speckit_is_false(self):
    ...
    def test_disabled_when_speckit_is_none(self):
...
class TestEnableSpeckit:
    ...
    def test_enable_with_custom_values(self):
        """Test enabling SpecKit with custom values."""
        with patch("mcp_server_guide.services.speckit_manager.SessionManager") as mock_session_class:
            mock_session = MagicMock()
            mock_session_class.return_value = mock_session

            enable_speckit("https://github.com/custom/repo", "v2.0.0")
    ...
    def test_enable_overwrites_existing(self):
        """Test that enabling overwrites existing configuration."""
        with patch("mcp_server_guide.services.speckit_manager.SessionManager") as mock_session_class:
            mock_session = MagicMock()
            mock_session_class.return_value = mock_session

            enable_speckit("https://github.com/new/repo", "v3.0.0")
...
class TestUpdateSpeckitConfig:
    ...
    def test_update_existing_config(self):
        ...
        with patch("mcp_server_guide.services.speckit_manager.SessionManager") as mock_session_class:
            ...
            update_speckit_config({"version": "v2.0.0"})
    ...
    def test_update_nonexistent_config(self):
        ...
        with patch("mcp_server_guide.services.speckit_manager.SessionManager") as mock_session_class:
            ...
            update_speckit_config({"enabled": True, "version": "v1.5.0"})
