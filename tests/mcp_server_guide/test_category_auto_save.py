...
def test_add_category_triggers_auto_save(mock_session_with_save):
...
def test_update_category_triggers_auto_save(mock_session_with_save):
    """Test that updating a category triggers auto-save."""
    # This test should FAIL initially, demonstrating the missing functionality
    result = update_category("guide", "guide/", ["guidelines.md"], description="Updated description")
...
def test_remove_category_triggers_auto_save(mock_session_with_save):
    """Test that removing a category triggers auto-save."""
    # Add a custom category first to the mock config
    config = mock_session_with_save.session_state.get_project_config.return_value
    config["categories"]["custom"] = {"dir": "custom/", "patterns": ["*.md"], "description": ""}

    # This test should FAIL initially, demonstrating the missing functionality
    result = remove_category("custom")
...
def test_auto_save_uses_default_config_filename(mock_session_with_save):
...
def test_auto_save_handles_save_errors_gracefully(mock_session_with_save):
