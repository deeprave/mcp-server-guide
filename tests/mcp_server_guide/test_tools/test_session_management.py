...
class TestSetDirectory:
    ...
    def test_set_directory_success(self, tmp_path):
        ...
        with patch("mcp_server_guide.tools.session_management.SessionManager") as mock_session_class:
            ...
            result = set_directory(str(tmp_path))
    ...
    def test_set_directory_symlinks(self, tmp_path):
        ...
        result = set_directory(str(file_symlink))
        assert result["success"] is False
        ...
        with patch("mcp_server_guide.tools.session_management.SessionManager") as mock_session_class:
            ...
            result = set_directory(str(dir_symlink))
            assert result["success"] is True

    def test_set_directory_exception(self, tmp_path):
...
class TestLoadSession:
    ...
    def test_load_session_success_with_full_state(self, tmp_path):
        ...
        with (
            ...
            mock_manager.load_full_session_state.return_value = True
            mock_manager_class.return_value = mock_manager

            result = load_session(tmp_path, "test_config.json")
    ...
    def test_load_session_fallback_to_project_loading(self, tmp_path):
        ...
        with (
            ...
            mock_manager = MagicMock()
            mock_manager.load_full_session_state.return_value = False
            mock_manager_class.return_value = mock_manager
    ...
    def test_load_session_default_path(self):
        ...
        with (
            ...
            result = load_session(None, "test_config.json")
    ...
    def test_load_session_invalid_path_type(self, tmp_path):
        ...
        result = load_session(file_path, "test_config.json")
        assert result["success"] is False
        ...
        result = load_session(file_symlink, "test_config.json")
        assert result["success"] is False
        assert "exists but is not a directory" in result["error"]
        ...
        result = load_session(dir_symlink, "test_config.json")
        assert result["success"] is True

    def test_load_session_exception(self, tmp_path):
...
class TestResetSession:
    ...
    def test_reset_session_exception(self):
