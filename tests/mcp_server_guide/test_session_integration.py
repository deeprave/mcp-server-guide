...
class TestSessionIntegration:
    ...
    async def test_session_config_works(self):
        ...
        await set_project_config("docroot", "/custom/session/path")
        await set_project_config("guide", "session-guidelines")
    ...
    async def test_session_config_precedence(self):
        ...
        await set_project_config("language", "session-python")
    ...
    async def test_session_local_file_resolution(self):
        ...
        await set_project_config("language", "file://./session-lang.md")
    ...
    async def test_mixed_session_and_default_config(self):
        ...
        await set_project_config("guide", "session-guide")
    ...
    async def test_project_switching_affects_server(self):
        ...
        await set_project_config("guide", "project-a-guide")
        await set_project_config("guide", "project-b-guide")
    ...
    async def test_session_path_resolution_in_server(self):
        ...
        await set_project_config("guide", "local:./client-guide.md")
        await set_project_config("language", "file:///server/lang.md")
        await set_project_config("docroot", "./relative-path")
